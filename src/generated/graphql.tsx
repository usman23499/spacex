...
export type LanchMissionInfoQueryVariables = Exact<{
  id: Scalars['String'];
}>;


export type LanchMissionInfoQuery = (
  { __typename?: 'Query' }
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
...
export const LanchMissionInfoDocument = gql`
...
/**
 * __useLanchMissionInfoQuery__
 *
 * To run a query within a React component, call `useLanchMissionInfoQuery` and pass it any options that fit your needs.
 * When your component renders, `useLanchMissionInfoQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLanchMissionInfoQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useLanchMissionInfoQuery(baseOptions: Apollo.QueryHookOptions<LanchMissionInfoQuery, LanchMissionInfoQueryVariables>) {
        return Apollo.useQuery<LanchMissionInfoQuery, LanchMissionInfoQueryVariables>(LanchMissionInfoDocument, baseOptions);
      }
export function useLanchMissionInfoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LanchMissionInfoQuery, LanchMissionInfoQueryVariables>) {
          return Apollo.useLazyQuery<LanchMissionInfoQuery, LanchMissionInfoQueryVariables>(LanchMissionInfoDocument, baseOptions);
        }
export type LanchMissionInfoQueryHookResult = ReturnType<typeof useLanchMissionInfoQuery>;
export type LanchMissionInfoLazyQueryHookResult = ReturnType<typeof useLanchMissionInfoLazyQuery>;
export type LanchMissionInfoQueryResult = Apollo.QueryResult<LanchMissionInfoQuery, LanchMissionInfoQueryVariables>;